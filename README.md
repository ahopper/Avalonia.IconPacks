# Avalonia.IconPacks
Import of more than 19,000 vector icons from the Visual Studio image library and [MahApps.Metro.IconPacks](https://github.com/MahApps/MahApps.Metro.IconPacks) for use in [Avalonia](https://github.com/AvaloniaUI/Avalonia)
